...
class MainTheme {
  ThemeData get theme => ThemeData(
    ...
    textTheme:
    Typography.englishLike2018.apply(fontSizeFactor: 1.sp).copyWith(
      headline1:  TextStyle(fontSize: 96, fontWeight: FontWeight.w700),
      ...
      subtitle2:  TextStyle(fontSize: 14, fontWeight: FontWeight.w700),
      bodyText1:  TextStyle(fontSize: 16, fontWeight: FontWeight.w700),
      bodyText2:  GoogleFonts.mulish(fontSize: 18, fontWeight: FontWeight.w400),
