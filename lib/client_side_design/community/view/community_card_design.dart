...
import 'package:sf_app/client_side_design/community/db/designer_cart_db.dart';
    ...
    return Scaffold(
      body: Padding(
        ...
        child: ListView.builder(
          shrinkWrap: true,
          itemCount: DesignerCartData().models.length,
                          ...
                          leading: Container(
                            ...
                            decoration: ShapeDecoration(
                                ...
                                image: DecorationImage(
                                    image: AssetImage(DesignerCartData().models[index].profileImage.toString()),
                                    fit: BoxFit.cover)),
                          ),
                          title: Padding(
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: <TextSpan>[
                              TextSpan(
                                text:
                                    DesignerCartData().models[index].disc.toString(),
                                style: GoogleFonts.mulish(
                              ...
                              TextSpan(
                                text: DesignerCartData().models[index].secondDis,
                                style: GoogleFonts.mulish(
          ...
          //                       shape: CircleBorder(),
          //                       image: DecorationImage(
          //                           image: AssetImage(DesignerCartData().models[0].profileImage.toString()),
          //                           fit: BoxFit.cover)),
          //                 ),
          //                 title: Padding(
          //                   padding: const EdgeInsets.only(left: 5.0),
          ...
          //                       designerCartModel: DesignerCartData().models[0],
          //                     ));
          //                    },
          //                   child: Image.asset('assets/Actions.png')),
          //               ),
